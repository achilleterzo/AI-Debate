...
export const LLM_TOOLS = [WEB_SEARCH_TOOL, FETCH_URL_TOOL, READ_ATTACHMENT_TOOL, GET_RECENT_MESSAGES_TOOL, QUOTE_MESSAGE_TOOL, REQUEST_MODERATOR_INTERVENTION_TOOL, MEMORY_TOOL]
